...
$string['experimental'] = 'Experimental Settings';
$string['studentsonly'] = 'Allow Students Only to improve performance';
$string['overwritefullname'] = 'Override Full Names and force "firstname lastname" to improve performance';
